...
To fix we need to do a 2 level inception getting inside vm and then ezpublish contaner, as that is difficult we just enter bash of a identical one with same eZ Publish volumen attached and same database linked:
- ```$ vagrant ssh```
